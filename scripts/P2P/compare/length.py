...
Usage:
    python scripts/P2P/compare/length.py [--config PATH] [--runtimes N]
...
all of them at once. Distance (1-100 km) is always the sweep axis. PLOB repeaterless
bound is overlaid by default; pass --no-plob to suppress it.
"""
