...
Usage:
    python scripts/P2P/raw/mdi_script.py [--config PATH] [--runtimes N] [--fibre F]
...
bs_eff=0.97). Pass --config configs/layer0_ideal.json for the idealised baseline.
fibre=20 km, runtimes=10.
"""
