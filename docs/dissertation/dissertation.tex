...
SPD cost depends primarily on detection efficiency and technology class. We model it as a linear function of detection efficiency $\eta$, anchored at two operating points: an InGaAs SPAD with $\eta = 0.20$ at £15,000, and an SNSPD with $\eta = 0.85$ at £100,000:
\begin{equation}
    C_\text{SPD}(\eta) = \frac{£100{,}000 - £15{,}000}{0.85 - 0.20}\,(\eta - 0.20) + £15{,}000.
    \label{eq:spd_cost}
\end{equation}
...
SPD (SPAD, $\eta=0.20$) & £15,000 & Linear model anchor \\
SPD (SNSPD, $\eta=0.85$) & £100,000 & Linear model anchor \\
...
2 & Detector efficiency (Z basis) & $\eta_Z$ & 0.65 & \\
3 & Dark count rate & $d_c$ & 100~cps & \\
