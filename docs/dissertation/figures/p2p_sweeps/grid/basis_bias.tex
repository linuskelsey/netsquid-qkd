...
title={(d) Key Rate vs Basis Bias},
legend cell align={left},
legend pos=south west,
legend style={fill opacity=0.8, draw opacity=1, text opacity=1, draw=lightgray204, font=\fontsize{6}{8}\selectfont},
log basis y={10},
tick align=outside,
tick pos=left,
x dir=reverse,
...
(axis cs:0.65,25.5957294486317)
--(axis cs:0.65,421.359660424859)
--(axis cs:0.9,421.359660424859)
--(axis cs:0.9,25.5957294486317)
--cycle;
...
\draw (axis cs:0.775,410) node[
  font=\fontsize{6}{8}\selectfont,
  anchor=north,
  text=darkred,
  rotate=0.0
]{\itshape Realistic regime};
\end{axis}
\end{tikzpicture}
