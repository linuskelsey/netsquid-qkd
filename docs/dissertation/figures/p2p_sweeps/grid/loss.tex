...
title={(a) Key Rate vs Fibre Loss},
...
(axis cs:0.15,17.3005432522986)
--(axis cs:0.15,16535.2938160824)
--(axis cs:0.25,16535.2938160824)
--(axis cs:0.25,17.3005432522986)
--cycle;
...
\draw (axis cs:0.02,10200) node[
  font=\fontsize{6}{8}\selectfont,
  anchor=north,
  text=black,
  rotate=0.0
]{\itshape PLOB};
\draw (axis cs:0.2,11500) node[
  font=\fontsize{6}{8}\selectfont,
  anchor=north,
  text=darkred,
  rotate=0.0
]{\itshape \shortstack{Corning\\SMF-28}};
\end{axis}
\end{tikzpicture}
