...
\begin{frame}{NetSquid in Action: P2P Parameter Sweeps}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \fcolorbox{blue!20!black}{white}{\includegraphics[width=0.94\linewidth]{artefacts/img/efficiency.png}}
        \end{column}
        \begin{column}{0.48\textwidth}
            \setlength{\fboxsep}{0pt}
            \setlength{\fboxrule}{0.6pt}
            \fcolorbox{blue!20!black}{white}{\includegraphics[width=\linewidth]{artefacts/img/charlie_pos.png}}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Network Methodologies}
    ...
    \fcolorbox{blue!20!black}{white}{\includegraphics[width=0.95\linewidth]{artefacts/img/network_topology_viz.png}}
...
\begin{frame}{NetSquid in Action: Network Scale Results}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.6pt}
            \fcolorbox{blue!20!black}{white}{\includegraphics[width=0.94\linewidth]{artefacts/img/network_relay_count_20_users.png}}
        \end{column}
        \begin{column}{0.48\textwidth}
            \setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.6pt}
            \fcolorbox{blue!20!black}{white}{\includegraphics[width=0.94\linewidth]{artefacts/img/network_user_count_10_to_25.png}}
        \end{column}
    \end{columns}
...
\begin{frame}{Bottleneck: Computational Cost}
    ...
    \begin{columns}[c]
        ...
        \begin{column}{0.52\textwidth}
            \setlength{\fboxsep}{0pt}\setlength{\fboxrule}{0.6pt}
            \fcolorbox{blue!20!black}{white}{\includegraphics[width=0.9\columnwidth]{../../figures/July/17Jul26-overnight/time_vs_users.png}}
        \end{column}
    \end{columns}
...
\begin{frame}{Adaptive Sampling: Protocol-Dependent Results}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.56\textwidth}
            \hspace{-0.4cm}\fbox{\includegraphics[width=1.02\columnwidth]{../../figures/July/17Jul26-overnight/adaptive_mc_bb84.png}}

            \vspace{0.4cm}
            \hspace{-0.4cm}\fbox{\includegraphics[width=1.02\columnwidth]{../../figures/July/17Jul26-overnight/adaptive_mc_mdi.png}}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Surrogate Modelling: Preliminary Results}
    ...
    \begin{columns}[T]
        ...
        \end{column}
        \begin{column}{0.56\textwidth}
            \fbox{\includegraphics[width=0.94\columnwidth]{../../figures/July/17Jul26-overnight/surrogate_bb84.png}}

            \vspace{0.4cm}
            \fbox{\includegraphics[width=0.94\columnwidth]{../../figures/July/17Jul26-overnight/surrogate_mdi.png}}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Backup: Physical Parameter Reference}
    ...
    \begin{tabular}{llll}
        ...
        \lighthline
        Fibre dephasing       & $\beta$         & $10^{-5}$--$10^{-3}$/km & $10^{-4}$/km \\
        \lighthline
